...
public class StringMethods {
    ...
    public static String getNonNullString (TextInputEditText mTextInputEditText, String defaultString){
        return  mTextInputEditText.getText().toString().isEmpty() ? defaultString : mTextInputEditText.getText().toString();
    }
